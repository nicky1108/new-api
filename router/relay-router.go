...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth(), middleware.Distribute())
	{
		...
		playgroundRouter.POST("/images/generations/stream", controller.PlaygroundImageStream)
		playgroundRouter.POST("/images/edits", controller.PlaygroundImage)
		playgroundRouter.POST("/images/edits/stream", controller.PlaygroundImageStream)
	}
